...
export const BLOCK_DEFS: Record<BlockId, BlockDef> = {
  ...
  [BLOCK.BOOKSHELF]: {
    id: BLOCK.BOOKSHELF,
    name: "Bookshelf",
    faces: topBottomSides(TILE.PLANKS, TILE.PLANKS, TILE.BOOKSHELF),
    solid: true,
    transparent: false,
    emissive: 0,
    breakTime: 0.6,
  ...
  [BLOCK.DIAMOND_BLOCK]: {
    ...
    name: "Diamond Block",
    faces: allSame(TILE.DIAMOND_BLOCK),
    solid: true,
    transparent: false,
    emissive: 0,
    breakTime: 3,
  ...
  [BLOCK.TNT]: {
    id: BLOCK.TNT,
    name: "TNT",
    faces: topBottomSides(TILE.TNT_TOP, TILE.TNT_BOTTOM, TILE.TNT_SIDE),
    solid: true,
    transparent: false,
    emissive: 0,
    breakTime: 0,
